        ...
        <div className="container" style={{ maxWidth: '1450px' }}>
          <div className="service-hero-grid">
            ...
            <div className="service-hero-text">
              <h1>
                <span className="highlight">Radiant Skin.</span> <br/>
                <span className="accent">Visible Brightening.</span>
              </h1>
              <p>
                Professional clinical brightening treatments designed to restore your skin's natural luminance. 
                Achieve a flawlessly even tone with expert-led, US-FDA approved protocols.
              </p>
              <div className="hero-trust-badges">
                <div className="hero-trust-badge">
                  <span>✨</span>
                  <span>GLOWING RESULTS</span>
                </div>
                <div className="hero-trust-badge">
                  <span>🛡️</span>
