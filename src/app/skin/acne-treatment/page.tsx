        ...
        <div className="container" style={{ maxWidth: '1450px' }}>
          <div className="service-hero-grid">
            ...
            <div className="service-hero-text">
              <h1>
                <span className="highlight">Clear Skin.</span> <br/>
                <span className="accent">Beat Acne Forever.</span>
              </h1>
              <p>
                Advanced clinical acne solutions designed to eliminate breakouts and prevent future scarring. 
                Experience customized, US-FDA approved protocols for permanent skin health and clarity.
              </p>
              <div className="hero-trust-badges">
                <div className="hero-trust-badge">
                  <span>🛡️</span>
                  <span>CLINICALLY SAFE</span>
                </div>
                <div className="hero-trust-badge">
                  <span>✨</span>
