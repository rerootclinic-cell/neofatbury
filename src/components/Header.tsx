  ...
  return (
    <header style={wrapperStyle}>
      ...
      <div style={topBarStyle} className="top-bar-mobile-hide">
        <div className="flex items-center justify-between" style={{ height: '100%', padding: '0 1rem' }}>
          {/* Left */}
      ...
      <div style={mainNavStyle} className="main-nav-mobile">
        <div className="flex items-center justify-between" style={{ height: '100%', padding: '0 1rem', width: '100%' }}>
          {/* Logo */}
