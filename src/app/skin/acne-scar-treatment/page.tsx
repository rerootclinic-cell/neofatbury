          ...
          <div className="service-hero-grid">
            <div className="hero-visual-pillar">
              <div className="visual-image-wrapper">
                <Image src="/images/neofatbury-skin-standard.png" alt="Acne Scar Treatment" width={500} height={680} priority style={{ objectFit: 'cover', objectPosition: 'top center' }} />
              </div>
            </div>
            <div className="service-hero-text">
              <h1>Smooth Skin.<br/><span className="accent">Zero Acne Scars.</span></h1>
