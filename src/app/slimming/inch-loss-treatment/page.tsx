    ...
    <>
      ...
      <section className="service-hero">
        <div className="hero-bg-img">
          <Image src="/images/neofatbury-slimming-standard.png" alt="Inch Loss Treatment" fill style={{ objectFit: 'cover', objectPosition: 'right center' }} priority />
          ...
          <div className="service-hero-grid">
            ...
            <div className="service-hero-text">
              ...
              <p style={{ fontSize: '1.2rem', color: '#333', fontWeight: '600', marginBottom: '2.5rem', maxWidth: '600px', lineHeight: '1.7' }}>
                Target stubborn fat and reduce inches with advanced, non-surgical treatments. Visible results with clinical precision.
              </p>
              <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '3rem' }}>
                <span className="chip">🛡️ Non-Surgical</span>
                <span className="chip">✨ Visible Inch Reduction</span>
              </div>
