    ...
    <>
      ...
      <section className="service-hero">
        <div className="hero-bg-img">
          <Image src="/images/neofatbury-cooling-tech.png" alt="CoolSculpting" fill style={{ objectFit: 'cover', objectPosition: 'right center' }} priority />
        ...
        <div className="container service-hero-container">
          <div className="service-hero-grid">
            ...
            <div className="service-hero-text">
              <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 3.8rem)', lineHeight: '1.2', fontWeight: '800', marginBottom: '1.5rem', color: '#1a1a1a' }}>
              ...
              <p style={{ fontSize: '1.2rem', color: '#333', fontWeight: '600', marginBottom: '2.5rem', maxWidth: '600px', lineHeight: '1.7' }}>
                Non-surgical fat reduction with advanced body contouring technology. Achieve your desired shape with zero surgery and zero downtime.
              </p>
              <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '3rem' }}>
                <span className="trust-item-sleek">❄️ Zero Downtime</span>
                <span className="trust-item-sleek">✅ FDA-Approved</span>
                <span className="trust-item-sleek">✨ Visible Results</span>
              </div>
